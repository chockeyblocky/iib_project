...
def save_loss(name, history):
    """
    Saves model history using .pkl
    :param name: name of file under which to save history
    :param history: TF model history - generated by .fit()
    :return:
    """
    with open(PATH + 'model_histories/{}.pkl'.format(name), 'wb') as f:
...
def main():
    ...
    # save model
    save_model("2_block_nbody_cga_transformer_c", model)

    # save losses
    save_loss("2_block_nbody_cga_transformer_c_history", model_train)
