...
class RotorConv1D(GeometricAlgebraLayer):
    ...
    def rotor_conv1d(
        ...
        x = tf.einsum("...abci,hij,...abcd,bcfg,dgh->...afj", self.algebra.reversion(a_slices), self.algebra._cayley,
                      a_slices, k_blade_values, self.algebra._cayley)
        # this works to implement sandwich product; add ...abc indices for weights if weighted kernel desired
